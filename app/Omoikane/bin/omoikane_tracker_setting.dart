...
class TrackerSetting {
  ...
  String settingfilePath = "../../../setting_tracker";

  static String getIp(Map<String, Object> p, String def) {
    return Bencode.toText(p, TrackerSetting.KEY_IP, def);
  }

  static int getPort(Map<String, Object> p, int def) {
    return Bencode.toNum(p, TrackerSetting.KEY_PORT, def);
  }

  static List<String> getHashlist(Map<String, Object> p) {
    List list = Bencode.toList(p, TrackerSetting.KEY_HASHLIST);
    List ret = [];
